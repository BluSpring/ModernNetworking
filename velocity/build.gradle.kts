...
dependencies {
    ...
    shadedDep(api(project(":api")) { isTransitive = false })
    shadedDep("org.jetbrains.kotlin:kotlin-stdlib")
...
tasks {
    ...
    getByName<ShadowJar>("shadowJar") {
        ...
        relocate("org.intellij", "$shadePkg.intellij")
    }
}
