...
object VanillaPacketSender {
     ...
     */
    @Deprecated(message = "Replaced with client-sided implementation", replaceWith = ReplaceWith("sendToServer", "xyz.bluspring.modernnetworking.api.minecraft.VanillaPacketSenderClient"))
    @JvmStatic
    fun sendToServer(packet: NetworkPacket) {
        VanillaPacketSenderClient.sendToServer(packet)
    }
