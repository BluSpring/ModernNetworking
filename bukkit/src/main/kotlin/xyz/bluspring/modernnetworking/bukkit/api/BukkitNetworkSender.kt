...
@Deprecated(level = DeprecationLevel.HIDDEN, message = "Rewritten to use a significantly improved network system", replaceWith = ReplaceWith("BukkitPacketSender", "xyz.bluspring.modernnetworking.bukkit.api.v2.packet.BukkitPacketSender"))
