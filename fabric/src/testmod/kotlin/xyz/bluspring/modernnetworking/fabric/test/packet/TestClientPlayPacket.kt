...
data class TestClientPlayPacket(
    ...
    companion object {
        val CODEC = CompositeCodecs.composite(
            NetworkCodecs.STRING_UTF8, TestClientPlayPacket::testString,
            NetworkCodecs.BYTE_ARRAY, TestClientPlayPacket::testByteArray,
            ::TestClientPlayPacket
        )
    }
}
